...
public class RingSocket{
    ...
    //Number of milli seconds after this RingSocket is created
    ...
    //Time of creation of this RingSocket
    ...
    */
     ...
     */
    public RingSocket(String host, int port) throws IOException{
    ...
    public RingSocket(Socket soc) throws IOException{
        socket = soc;
